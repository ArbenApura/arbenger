...
export const skillGroups: SkillGroup[] = [
	...
	{
		name: 'Hosting & DevOps',
		skills: ['Vercel', 'Render', 'Cloudflare Pages', 'Plesk', 'Webuzo', 'Nginx', 'VPS', 'CI/CD', 'Monorepo', 'Git'],
	},
	{
		name: 'AI & APIs',
		skills: ['OpenAI API', 'Google AI Studio API', 'DeepSeek API', 'LLM prompt engineering', 'REST APIs'],
	},
];
