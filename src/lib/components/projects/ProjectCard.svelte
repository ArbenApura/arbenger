...
>
	...
	<div class="flex flex-1 flex-col gap-4 p-6">
		...
		<!-- FOOTER -->
		<div class="flex flex-wrap items-center justify-between gap-x-3 gap-y-2 border-t border-[#F1F5F9] pt-4 dark:border-[#2A2578]/40">
			<span class="min-w-0 text-xs text-[#94A3B8] dark:text-slate-500">{project.role}</span>
			<span class="flex shrink-0 items-center gap-1 text-sm font-medium text-[#0891B2] transition-all group-hover:gap-2 dark:text-[#22D3EE]">
				View project
