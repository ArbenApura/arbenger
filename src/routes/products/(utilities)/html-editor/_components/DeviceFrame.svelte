...
{:else if preset === 'mobile'}
	...
	<div class="h-full w-full overflow-auto">
		<div class="inline-flex min-h-full min-w-full items-start justify-center p-6">
			<div
...
{:else if preset === 'desktop'}
	<!-- MONITOR FRAME -->
	<div class="h-full w-full overflow-auto">
		<div class="inline-flex min-h-full min-w-full flex-col items-center justify-start p-6 pt-8">
			<!-- MONITOR -->
			<div
