	...
	>
		...
		<section class="resume-section mt-2">
			...
			<ul class="mt-2 list-disc space-y-0 pl-4 text-[10.5pt] leading-[1.2] text-[#334155]">
				<li>Door Lock Module (2024-2025) - IoT smart door lock using RFID and face recognition, built with Arduino and a web app for access; registered with the Intellectual Property Office of the Philippines (IPOPHL).</li>
		...
		<section class="resume-section mt-2">
			...
			<div class="mt-2 space-y-1 text-[10.5pt] leading-[1.2] text-[#334155]">
				...
				<p><span class="font-semibold text-[#0F172A]">AI and APIs:</span> OpenAI API, Google AI Studio API, DeepSeek API, LLM prompt engineering</p>
			</div>
		</section>
