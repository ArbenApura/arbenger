	...
	>
		...
		<section class="resume-section mt-2">
			...
			<ul class="mt-2 list-disc space-y-0 pl-4 text-[10.5pt] leading-[1.2] text-[#334155]">
				<li>Door Lock Module (2026) - developed an Arduino-based smart door lock using RFID and face recognition; successfully registered the project with the Intellectual Property Office of the Philippines (IPOPHL).</li>
