	...
	const TIMELINE = [
		{
			...
			points: [
				...
				'Integrated Google Play Billing with idempotent purchase verification and RTDN webhook endpoints that synchronize purchase lifecycle events (purchased, renewed, cancelled, expired) to the database.',
			],
		},
		{
			role: 'Full-Stack Developer',
