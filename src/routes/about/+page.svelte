	...
	const TIMELINE = [
		{
			...
			points: [
				...
				'Integrated Google Play Billing with idempotent purchase verification to prevent duplicate transactions and secure in-app purchases.',
			],
		},
		{
			role: 'Full-Stack Developer',
			...
			points: [
				...
				'Created a full admin panel on PostgreSQL with Drizzle ORM: app CMS, multi-language support (manual, DeepL, and Gemini AI translation), orders and sales, and usage statistics.',
